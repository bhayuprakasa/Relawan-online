...
<body onload="MM_preloadImages('Gambar/Log Out 1.png','Gambar/Home 1.png','Gambar/Event Gallery 1.png','Gambar/Event 1.png')">
<table width="100%" border="0">
  <tr>
    <td width="19" height="128" align="center" valign="middle"><table width="100%" border="0">
      <tr>
        <td align="right">Hi, Username! <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Log Out','','Gambar/Log Out 1.png',1)"><img src="Gambar/Log Out.png" width="165" height="32" id="Log Out" /></a></td>
      </tr>
      <tr>
...
<table width="89%" border="0">
  <tr>
    <th align="right" scope="col"><a href="Sukses Join Event.php"><img src="Gambar/Submit.png" width="102" height="27" /></a></th>
  </tr>
</table>
<p>&nbsp;</p>
</body>
