...
$MM_restrictGoTo = "Gagal Login.php";
...
$query_SignUp = "SELECT * FROM `sign up`";
$SignUp = mysql_query($query_SignUp, $Sign_Up) or die(mysql_error());
