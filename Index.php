...
<table width="100%" border="0">
  <tr>
    <td height="148" align="right"><table width="100%" border="0">
      ...
      <img src="Gambar/Logo.png" alt="" width="606" height="69" /></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
  <tr>
    <td width="52%" align="center" scope="col"><?php echo $row_Recordset1['Description']; ?></td>
    <td width="48%" align="center" scope="col"><?php echo $row_Recordset1['Description']; ?></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
