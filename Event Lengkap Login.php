...
mysql_select_db($database_Sign_Up, $Sign_Up);
$query_Recordset2 = "SELECT * FROM event";
...
<table width="100%" border="0">
  <tr>
    <td align="right">Hi, <?php echo $row_Recordset1['Username']; ?>! <a href="Index.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Log Out','','Gambar/Log Out 1.png',1)"><img src="Gambar/Log Out.png" alt="v" width="165" height="32" id="Log Out2" /></a></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
  <tr>
        <th align="center" scope="col"><?php echo $row_Recordset2['Title']; ?></th>
  </tr>
      <tr>
        <th align="center" scope="col">Gambar</th>
      </tr>
      <tr>
        <td align="center"><?php echo $row_Recordset2['Description']; ?></td>
      </tr>
</table>
    <table width="72%" border="0">
      <tr>
        <th align="right" scope="col"><a href="Join Event.php"><img src="Gambar/Join.png" width="102" height="27" /></a> <a href="Diskusi.php"><img src="Gambar/Diskusi.png" width="102" height="27" /></a></th>
      </tr>
    </table>
    <p>&nbsp;</p>
    <p>&nbsp;	</p>
